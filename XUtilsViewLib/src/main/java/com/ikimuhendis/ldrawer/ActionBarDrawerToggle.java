...
/**
 * ActionBar的侧边栏使用DrawerLayout的监听器实现
 * @ClassName: ActionBarDrawerToggle
 * @Description: TODO
 * @author qh@plusub.com
 * @date 2015-5-15 下午3:38:27
 * @version v1.0
 */
public class ActionBarDrawerToggle extends android.support.v4.app.ActionBarDrawerToggle {
     ...
     * <p>Title: 
     * <p>Description: 
     * @param activity 附属的activity
     * @param drawerLayout 抽屉视图layout
     * @param drawerImage 指示抽屉的图片(自定义实现，带有动画效果)
