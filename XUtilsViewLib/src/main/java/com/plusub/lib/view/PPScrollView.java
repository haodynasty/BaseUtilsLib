 ...
 * @ClassName: KJScrollView
 * @Description: TODO
 * @author qh@plusub.com
 * @date 2014-12-1 下午9:34:53
 * @version v1.0
 */
public class PPScrollView extends ScrollView {
    ...
    public PPScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
     ...
     */
    private void setOnRefreshListener(PPRefreshListener l) {}
