...
public class FragmentPageAdapter extends FragmentPagerAdapter {
	...
	public FragmentPageAdapter(FragmentManager fm, List<BaseFragment> list) {
		super(fm);
	...
	public void setData(ArrayList<BaseFragment> list){
		this.list = list;
	}
	
	public void addData(BaseFragment fragment){
		this.list.add(fragment);
	}
	
	public void addDataHead(BaseFragment fragment){
