 ...
 * </ul>
 * <p>{@link #LogUtils openLog() 打开日志输出（打印输出和文件输出总开关）}</p>
 * <p>{@link #LogUtils closeLog() 关闭日志输出（打印输出和文件输出）}</p>
 * <p>{@link #LogUtils setSyns(boolean) 文件输出开关}</p>
 * <p>
 * 需要注册权限：
 * <table>
 *  <tr>
...
public class LogUtils {
	...
	/** 是否同步输出到本地日志文件 */
	private static boolean IS_SYNS = PlusubConfig.isLogSaveToFileSwitch;
	/** 打印日志保存路径*/
	...
	private static boolean DEBUG_MODE = BuildConfig.DEBUG ? true : PlusubConfig.isDebugSwitch;
