...
/**
 * application lifecycle dispatcher,equals SDK>=14 {@link Application.ActivityLifecycleCallbacks},can register many callback,you can use for log switch and umeng and so on
 * <p>
 *     register Activity:{@link #registerActivityLifecycleCallbacks(Application, ActivityLifecycleCallbacksCompat)}
 * unregister Activity:{@link #unregisterActivityLifecycleCallbacks(Application, ActivityLifecycleCallbacksCompat)}
 * </p>
 * for Fragment:
 * <p>
 * register fragment:{@link #registerFragmentLifecycleCallbacks(Application, FragmentLifecycleCallbacks)}
 * unregister fragment:{@link #unregisterFragmentLifecycleCallbacks(Application, FragmentLifecycleCallbacks)}
 * <p/>
 */
public class LifecycleDispatcher implements ActivityLifecycleCallbacksCompat, FragmentLifecycleCallbacks {
    ...
    /************************************next is activity and fragment callback,if register many Callback will run one by one******************************/
    ...
    public void onFragmentAttach(Fragment fragment,
        ...
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
                ((FragmentLifecycleCallbacks) callbacks[i]).onFragmentAttach(fragment, context);
            }
        }
    }
